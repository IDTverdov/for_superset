...
name, number_stream, new = 'Эффективный руководитель', 4, True
...
# 13. Считываем, кто посмотрел 
dfs = rf.read_progress(f_progress, exrs)
r.insert_exsercise(dfs, id_programm, id_stream)

# 14. Добавляем обратную связь
dfs = rf.read_os_lesson(f_os_lesson)
r.insert_exsercise_feedback(dfs, id_stream)

# 15. Добавить слушателей к модулям
r.insert_module(id_stream, id_programm)
